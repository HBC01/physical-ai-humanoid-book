...
const config: Config = {
  ...
  tagline: 'Interactive Learning Platform for Robotics',
  ...
  organizationName: 'HBC01', // Usually your GitHub org/user name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} Physical AI Humanoid Book. Built with Docusaurus.`,
    },
    prism: {
